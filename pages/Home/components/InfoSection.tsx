...
const InfoSection: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row items-start gap-8 border-t-4 border-zinc-900 dark:border-zinc-100 pt-8 w-full max-w-3xl animate-fade-in delay-400 opacity-0" style={{ animationFillMode: 'forwards' }}>
      ...
      <div className="flex flex-col gap-3 text-[10px] font-black uppercase tracking-widest text-zinc-500 min-w-[140px] border-l-2 border-zinc-200 dark:border-zinc-800 pl-6 md:pl-8">
        <div className="flex items-center gap-3 group cursor-default animate-slide-in-right delay-500 opacity-0" style={{ animationFillMode: 'forwards' }}>
        ...
        <div className="flex items-center gap-3 group cursor-default animate-slide-in-right delay-700 opacity-0" style={{ animationFillMode: 'forwards' }}>
        ...
        <div className="flex items-center gap-3 group cursor-default animate-slide-in-right delay-900 opacity-0" style={{ animationFillMode: 'forwards' }}>
          <div className="w-1.5 h-1.5 bg-zinc-400 dark:bg-zinc-600 group-hover:bg-red-500 transition-colors"></div>
